...
function PassengerCam() {
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Passenger Camera Page)');
      ...
      TOPICS.forEach(({ name, rosTopic, messageType }) => {
        ...
        topic.subscribe((msg: any) => {
          ...
          // Camera display in PassengerBoxCamFront
          ...
          // Lidar visualization in PassengerBoxCam2
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      <div className={shapes.PassengerCamDiagText}>
      ...
      <div className={shapes.PassengerBoxCamFront}>
        <canvas 
          ref={cameraCanvasRef}
          width={1920}
          height={1080}
      ...
      {/* Lidar Display */}
      <div className={shapes.PassengerBoxCam2}>
        <canvas 
          ref={lidarCanvasRef}
          width={800}
          height={600}
