...
function PassengerSens() {
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Passenger Sensory Page)');
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      {/* Box 1: Camera */}
      <div className={shapes.PassengerSensBox1}>
        <canvas 
          ref={cameraCanvasRef}
          width={800}
          height={600}
      ...
      {/* Box 2: Lidar */}
      <div className={shapes.PassengerSensBox2}>
        <canvas 
          ref={lidarCanvasRef}
          width={800}
          height={600}
      ...
      {/* Box 3: GPS */}
      <div className={shapes.PassengerSensBox3}>
        <canvas 
          ref={gpsCanvasRef}
          width={800}
          height={600}
      ...
      {/* Box 4: IMU */}
      <div className={shapes.PassengerSensBox4}>
        <canvas 
          ref={imuCanvasRef}
          width={800}
          height={600}
      ...
      <div className={shapes.PassengerSenBox1Title} style={{ 
      ...
      <div className={shapes.PassengerSenBox2Title} style={{ 
      ...
      <div className={shapes.PassengerSenBox3Title} style={{ 
      ...
      <div className={shapes.PassengerSenBox4Title} style={{ 
