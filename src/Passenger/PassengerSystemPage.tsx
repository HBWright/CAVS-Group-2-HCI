...
function PassengerSys() {
  ...
  const calculateHealth = () => {
    ...
    // Perception health (Camera + Lidar + GPS)
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Passenger System Page)');
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      <div className={shapes.PassengerSpd}>{speed.toFixed(0)} mph</div>
      
      {/* Mapping & Planning Box */}
      <div className={shapes.PassengerSysBoxPlan}>
        <canvas 
      ...
      {/* Control Box */}
      <div className={shapes.PassengerSysBoxCrtl}>
        <canvas 
      ...
      {/* Perception Box */}
      <div className={shapes.PassengerSysBoxPerc}>
        <canvas 
