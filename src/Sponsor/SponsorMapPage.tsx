...
function SponsorMap() {
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Sponsor Map Page)');
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      <div className={shapes.SponsorDiagText}>
      ...
      {/* GPS Map Display */}
      <div className={shapes.SponsorBoxGPS}>
        <canvas 
          ref={gpsCanvasRef}
          width={1200}
          height={800}
      ...
      {/* Camera Display */}
      <div className={shapes.SponsorBoxCam}>
        <canvas 
          ref={cameraCanvasRef}
          width={640}
          height={480}
      ...
      {/* Local Path Display */}
      <div className={shapes.SponsorBoxPath}>
        <canvas 
          ref={pathCanvasRef}
          width={600}
          height={600}
