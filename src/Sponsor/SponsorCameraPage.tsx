...
function SponsorCam() {
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Sponsor Camera Page)');
      ...
      TOPICS.forEach(({ name, rosTopic, messageType }) => {
        ...
        topic.subscribe((msg: any) => {
          ...
          // Camera display in SponsorBoxCamFront
          ...
          // Lidar visualization in SponsorBoxCam2
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      <div className={shapes.SponsorCamDiagText}>
      ...
      <div className={shapes.SponsorBoxCamFront}>
        <canvas 
          ref={cameraCanvasRef}
          width={1920}
          height={1080}
      ...
      {/* Lidar Display */}
      <div className={shapes.SponsorBoxCam2}>
        <canvas 
          ref={lidarCanvasRef}
          width={800}
          height={600}
