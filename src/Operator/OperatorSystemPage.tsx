...
function OperatorSys() {
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (System Page)');
  ...
  useEffect(() => {
    const drawPlanning = () => {
      ...
      ctx.fillStyle = topicStatus.Lidar ? '#00ff00' : '#ff0000';
      ctx.beginPath();
      ctx.arc(30, yPos + 26, 8, 0, 2 * Math.PI);
      ctx.fill();
      ctx.fillStyle = '#C1C6C8';
      ctx.font = 'bold 40px Arial';
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      <div className={shapes.OperatorSysBoxPlan}>
        <canvas 
      ...
      {/* Control Box */}
      <div className={shapes.OperatorSysBoxCrtl}>
        <canvas 
      ...
      {/* Perception Box */}
      <div className={shapes.OperatorSysBoxPerc}>
        <canvas 
