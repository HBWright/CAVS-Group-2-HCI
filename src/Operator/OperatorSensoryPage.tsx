...
function OperatorSens() {
  ...
  const [gpsData, setGpsData] = useState<{ lat: number; lon: number; alt: number } | null>(null);
  const [imuData, setImuData] = useState<any>(null);
  const [lidarPointCount, setLidarPointCount] = useState<number>(0);
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Sensory Page)');
      ...
      TOPICS.forEach(({ name, rosTopic, messageType }) => {
        ...
        topic.subscribe((msg: any) => {
          ...
          if (name === 'Lidar' && msg.data && lidarCanvasRef.current) {
            ...
            setLidarPointCount(pWidth * pHeight);

            // Draw point cloud (top-down view)
          ...
          if (name === 'GPS' && msg.latitude && msg.longitude) {
            setGpsData({ lat: msg.latitude, lon: msg.longitude, alt: msg.altitude });
  ...
  return (
    ...
    <div className={styles.ProfilePageContainer}>
      ...
      <div className={shapes.OperatorSpd}>
        {speed.toFixed(0)} mph
      </div>
      
      {/* Box 1: Camera */}
      <div className={shapes.OperatorSensBox1}>
        <canvas 
          ref={cameraCanvasRef}
          width={800}
          height={600}
      ...
      {/* Box 2: Lidar */}
      <div className={shapes.OperatorSensBox2}>
        <canvas 
          ref={lidarCanvasRef}
          width={800}
          height={600}
      ...
      {/* Box 3: GPS */}
      <div className={shapes.OperatorSensBox3}>
        <canvas 
          ref={gpsCanvasRef}
          width={800}
          height={600}
      ...
      {/* Box 4: IMU */}
      <div className={shapes.OperatorSensBox4}>
        <canvas 
          ref={imuCanvasRef}
          width={800}
          height={600}
      ...
      <div className={shapes.OperatorSenBox1Title} style={{ 
      ...
      <div className={shapes.OperatorSenBox2Title} style={{ 
      ...
      <div className={shapes.OperatorSenBox3Title} style={{ 
      ...
      <div className={shapes.OperatorSenBox4Title} style={{ 
